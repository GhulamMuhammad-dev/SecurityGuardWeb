...
const AboutSection = () => {
  return (
    <>
      ...
      <section
        className="w-full bg-[#1A1A1A] py-20 px-6 md:px-12 text-[#F4F4F4] "
        id="about"
      >
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <p className="text-[#F4F4F4] text-lg leading-relaxed">
              At{" "}
              <span className="text-[#EF443B] font-semibold">IntleafGuard</span>
              , we specialize in delivering advanced security solutions tailored
              to your needs. With a team of certified experts, cutting-edge
              technology, and round-the-clock service, we ensure your peace of
